      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div class="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow">
          <div class="flex justify-center items-center mb-6">
            <img src="/images/clients/directv.png" alt="DirecTV Logo" class="h-12 object-contain" />
        ...
        <div class="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow">
          <div class="flex justify-center items-center mb-6">
            <img src="/images/clients/sky.svg" alt="Sky Logo" class="h-12 object-contain" />
        ...
        <div class="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow">
          <div class="flex justify-center items-center mb-6">
            <img src="/images/clients/amazon.jpeg" alt="Amazon Logo" class="h-12 object-contain" />
